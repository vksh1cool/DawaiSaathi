/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.reminders.jsonc --env-interface=ReminderWorkerEnv cloudflare-reminders-env.d.ts` (hash: 3edef6f61c864aa9d45f92b7ac0ab48c)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_ReminderWorkerEnv {
	DAWAISAATHI_APP: Fetcher /* dawaisaathi */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/cloudflare-reminders");
	}
	interface Env extends __BaseEnv_ReminderWorkerEnv {}
}
interface ReminderWorkerEnv extends __BaseEnv_ReminderWorkerEnv {}
