/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 650e021b3cbf5d7946a4680938715182)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_DRIVER" | "STORAGE_DRIVER" | "NEXT_INC_CACHE_R2_PREFIX" | "REQUIRE_ACCESS_GATE" | "DEFAULT_TZ" | "DEMO_MODE" | "WORKER_TICK_SECONDS" | "RETRY_DELAY_MINUTES" | "MAX_CALL_ATTEMPTS" | "AI_PROVIDER" | "OPENAI_API_KEY" | "APP_ACCESS_PASSWORD" | "APP_SESSION_SECRET" | "REMINDER_CRON_TOKEN" | "OPENAI_DAILY_LLM_REQUEST_LIMIT" | "OPENAI_DAILY_TTS_GENERATION_LIMIT">> {}
}
