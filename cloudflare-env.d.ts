/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 70e2a838ae2f7717db7fa37d42288d08)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DAWAISAATHI_ASSETS: R2Bucket;
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	DAWAISAATHI_DB: D1Database;
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	DATABASE_DRIVER: "d1";
	STORAGE_DRIVER: "r2";
	...
	OPENAI_TTS_VOICE_FEMALE: string;
	OPENAI_TTS_VOICE_MALE: string;
	NIM_API_KEY: string;
	NIM_BASE_URL: string;
	OPENAI_DAILY_LLM_REQUEST_LIMIT: string;
	OPENAI_DAILY_TTS_GENERATION_LIMIT: string;
	...
	DEFAULT_TZ: string;
	DEMO_MODE: string;
	WORKER_TICK_SECONDS: string;
	RETRY_DELAY_MINUTES: string;
	MAX_CALL_ATTEMPTS: string;
	AUTH_DRIVER: string;
	SUPABASE_URL: string;
	SUPABASE_ANON_KEY: string;
	SUPABASE_TENANT_RUNTIME_READY: string;
	DEMO_PATIENT_PHONE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_DRIVER" | "STORAGE_DRIVER" | "NEXT_INC_CACHE_R2_PREFIX" | "REQUIRE_ACCESS_GATE" | "AI_PROVIDER" | "GROQ_API_KEY" | "GROQ_MODEL" | "GROQ_VISION_MODEL" | "OPENAI_API_KEY" | "OPENAI_TTS_MODEL" | "OPENAI_TTS_VOICE_FEMALE" | "OPENAI_TTS_VOICE_MALE" | "NIM_API_KEY" | "NIM_BASE_URL" | "OPENAI_DAILY_LLM_REQUEST_LIMIT" | "OPENAI_DAILY_TTS_GENERATION_LIMIT" | "TWILIO_ACCOUNT_SID" | "TWILIO_AUTH_TOKEN" | "TWILIO_FROM_NUMBER" | "PUBLIC_BASE_URL" | "DATABASE_URL" | "DIRECT_URL" | "OPENFDA_API_KEY" | "DEFAULT_TZ" | "DEMO_MODE" | "WORKER_TICK_SECONDS" | "RETRY_DELAY_MINUTES" | "MAX_CALL_ATTEMPTS" | "AUTH_DRIVER" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "SUPABASE_TENANT_RUNTIME_READY" | "DEMO_PATIENT_PHONE">> {}
}
