...
- `goodbye_noinput`: «कोई बात नहीं। दवाई ज़रूर ले लीजिएगा। हम थोड़ी देर में फिर फ़ोन करेंगे। नमस्ते।»
- `goodbye_final` (last retry exhausted, played if answered but no input): «कृपया दवाई ले लीजिएगा और {caregiverName} को बता दीजिएगा। नमस्ते।»
...
- `goodbye_noinput`: “That's alright. Please do take your medicines. We will call again shortly. Goodbye.”
